export function NewsFeedIcon() {
  return (
    ...
    >
      ...
      >
        <stop offset="0" html-stop-color="#2bb24c"></stop>
        <stop offset="1" html-stop-color="#2bb24c"></stop>
      </linearGradient>
      <path
      ...
      <rect width="14" height="3" x="24" y="30" fill="#2bb24c"></rect>
      <path
        fill="#2bb24c"
